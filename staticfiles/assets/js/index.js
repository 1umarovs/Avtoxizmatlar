...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const ulElement = document.getElementById('category-list');
    const chevron = document.querySelector(".fa-chevron-down");

    if (!titleElement) {
        console.warn("title elementi topilmadi");
        return; // keyingi kodni bajarishni to'xtatamiz
    }
    if (!ulElement) {
        console.warn("list elementi topilmadi");
        return;
    }
    if (!chevron) {
        console.warn("fa-chevron-down elementi topilmadi");
        return;
    }
